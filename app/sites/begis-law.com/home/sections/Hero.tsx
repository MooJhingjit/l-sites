    ...
    <section className="container mx-auto  flex flex-wrap justify-between -m-6 pt-32 pb-20">
        ...
        <div className="flex flex-wrap -m-3 mb-20 items-center">
          ...
          <div className="w-full lg:w-auto p-3">
            <Link
              role="button"
              href="/testimonials"
              className="font-heading w-full px-6 py-4 text-base text-white bg-transparent border border-gray-500 hover:border-gray-600 rounded-md"
            >
      ...
      <div className="w-full lg:w-7/12 xl:w-1/2 p-6 pr-0">
        ...
        <div className="flex flex-wrap justify-center max-w-max -m-3 mb-3 xl:-ml-20">
          ...
          <div className="flex flex-wrap justify-center max-w-max -m-3 mb-3 xl:-ml-44">
          ...
          <div className="flex flex-wrap justify-center max-w-max -m-3 mb-3 xl:-ml-20">
            <div className="w-full sm:w-1/2 p-3">
              <ReviewBox
                name="Guy Hawkins"
                content="Insightful legal advice that really made a difference."
              />
            </div>
            <div className="w-full sm:w-1/2 p-3">
              <ReviewBox
