  ...
  return (
    <div className="bg-secondary/50  rounded-sm my-2 ">
      <div className=" text-xs max-w-7xl px-4 py-2 sm:flex sm:items-center">
        ...
        <p className="ml-2 text-orange-500 underline cursor-pointer">
          clear all
        </p>

        <div
          aria-hidden="true"
          className="hidden h-5 w-px bg-primary/20 sm:ml-4 sm:block"
        />

        <div className="mt-2 sm:ml-4 sm:mt-0">
          <div className="-m-1 flex flex-wrap items-center">
            {/* {activeFilters.map((activeFilter) => ( */}
            <span className="m-1 inline-flex items-center rounded-sm border bg-white  dark:bg-primary py-1 pl-3 pr-2 text-xs font-medium dark:text-primary-foreground">
